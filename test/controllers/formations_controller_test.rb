...
class FormationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formation" do
    assert_difference('Formation.count') do
      post formations_url, params: { formation: { description: @formation.description, endDate: @formation.endDate, location: @formation.location, name: @formation.name, startDate: @formation.startDate } }
    end
  ...
  test "should update formation" do
    patch formation_url(@formation), params: { formation: { description: @formation.description, endDate: @formation.endDate, location: @formation.location, name: @formation.name, startDate: @formation.startDate } }
